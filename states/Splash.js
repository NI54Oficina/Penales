...
var Splash = function () {};
  ...
  loadImages: function () {
	...
	game.load.atlas('pateador-ind', urlBase+'assets/singleplayer/images/pateador-ind.png', 'assets/singleplayer/images/pateador-ind.json', Phaser.Loader.TEXTURE_ATLAS_JSON_HASH);
	game.load.atlas('pateador-mufa', urlBase+'assets/singleplayer/images/pateador-mufa.png', 'assets/singleplayer/images/pateador-mufa.json', Phaser.Loader.TEXTURE_ATLAS_JSON_HASH);
	game.load.atlas('arquero-mufa', urlBase+'assets/singleplayer/images/arquero-mufa.png', 'assets/singleplayer/images/arquero-mufa.json', Phaser.Loader.TEXTURE_ATLAS_JSON_HASH);

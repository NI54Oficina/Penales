...
// funcion para los botones ordenados pero de las pantallas
  ...
  pantallaOponente: function () {
    self = this;

    //fondo

    groupPantallaOponente= game.group.add();
  ...
  createLineGlobal: function(a, b,c){
  ...
  createGeneralTitle: function(text, bool){
  ...
  createBackground: function(bool){
...
createHeader: function(callback, bool){
  if(bool){
  ...
  //a= game.add.sprite(this.game.width, 0, 'right-corner');
   ...
   volver.events.onInputDown.add(callback,volver);

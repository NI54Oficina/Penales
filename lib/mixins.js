...
//type:: listaDeTuplasConNombreDeBotonYCallback -> [(nombreDeBoton, Callback)]
 ...
 instrucciones(title,boolIns){
  ...
  // }
      ...
      pantallas=[screen1, screen2, screen3, screen4, screen5];
...
screen2: function(){
    ...
    number.setShadow(0, -3, '#ffffbd ', 0);
    group1.add(number);
    group1.add(game.add.text(0, 100, 'PATEADOR:\n Mantené pulsado sobre uno de los 6 lugares del arco a donde vas a apuntar', { font:  '25px TheSansRegular', fill: "#013884", align: "center",wordWrap: true, wordWrapWidth:600}));
    group1.add(this.game.add.sprite(0,number.height,'sombra-instrucciones'));
...
screen4: function(){
  ...
  number.setShadow(0, -3, '#ffffbd ', 0);
  group1.add(number);
  group1.add(game.add.text(0, 100, 'ARQUERO:\n Pulsá sobre uno de los 6 lugares del arco a donde vas a apuntar', { font:  '25px TheSansRegular', fill: "#013884", align: "center",wordWrap: true, wordWrapWidth:600}));
  group1.add(this.game.add.sprite(0,number.height,'sombra-instrucciones'));
...
screen5: function(){
  ...
  group1=game.add.group();
  number=game.add.text(0, 0, '5', { font:  '45px AlfaSlab', fill: "#013884", align: "center"});
  number.setShadow(0, -3, '#ffffbd ', 0);
  group1.add(number);
  var fontSplash={ font:  '25px TheSansRegular', fill: "#013884", align: "center",wordWrap: true, wordWrapWidth:600};
  group1.add(game.add.text(0, 100, 'ARQUERO:', fontSplash ));
  group1.add(this.game.add.sprite(0,number.height,'sombra-instrucciones'));
...
notificationDinamic: function( title, text, boolExitButton, listaDeTuplasConNombreDeBotonYCallback){

...
/*  Crea Lineas horizontale: recibe un X desde donde comienza la linea, hasta otro X,
    ,un Y que es constante, y un booleno que determina si llev o no sombra.
...
//0x797979
  ...
  */
  ...
  /*  Activa y desactiva el Sonido, utiliza las variables globales
      creadas en Splah.js
  */
  ...
  */
  ...
  /* Crea el fondo de las pantallas, el gradiente, los puntitos y la curva.
    Recive un booleano para determinar si lleva o no la curva.
    Devuelve todo en un grupo.
  */

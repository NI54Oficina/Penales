...
*/
  ...
  createLineGlobal: function(desdeX,Y, hastaX, boolShadow, colorLineHexa){
...
// FUNCIONES PARA LOS SPLASH DE NOTIFICACION
...
//type:: listaDeTuplasConNombreDeBotonYCallback -> [(nombreDeBoton, Callback)]
 ...
 notification(title, text, listaDeTuplasConNombreDeBotonYCallback){
  ...
  notificacionGroup.add(board);
      ...
      var x=game.add.text(50, 30, title, { font:  '30px CondensedLight', fill: "0259a3", align: "center"});
...
//type:: listaDeTupla -> [(nombreDeBoton, Callback)]
 ...
 generateButtonsInSplash: function(listaDeTupla){
       ...
       for(var i=0; i< listaDeTupla.length; i++ ){
              ...
              var  grd = colorBoton.context.createLinearGradient(0,0,0,this.game.height);
              grd.addColorStop(0,"#dfb443");

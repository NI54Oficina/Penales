 ...
 notification(title,boolIns, text, listaDeTuplasConNombreDeBotonYCallback){
  ...
  if( text != undefined){
   ...
   board.addChild(m);
      ...
      e=game.add.text(board.width-50, board.height-50, '>', { font:  '45px RobotoBold', fill: "#013884", align: "center"});
      board.addChild(e);
      e.inputEnabled = true;
      e.events.onInputDown.add(function(){console.log("here we are")});
  ...
  game.world.bringToTop(notificacionGroup);
      ...
      exit.events.onInputDown.add(function(){game.add.tween(notificacionGroup).to( { alpha: 0 }, 500, 'Linear', true, 0, 0, false);});
...
screen1: function(){
    ...
    group1.add(game.add.text(0, 80, 'Seleccioná el rival al que vas a enfrentar', { font:  '20px RobotoBold', fill: "#013884", align: "center"}));

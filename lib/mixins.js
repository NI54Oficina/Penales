...
screen2: function(){
    ...
    father= this.game.add.sprite(190,220,'arco-n');
    father.scale.setTo(.7,.7);

    d= this.game.add.sprite(0,220,'arco-0');
    d.scale.setTo(.70,.70);

    a=this.game.add.sprite(250,260,'orange-button');
    a.scale.setTo(1.5,1.5);
    group1.add(game.add.text(255, 265, 'A', { font:  '45px AlfaSlab', fill: "#013884", align: "center"}));

    b=this.game.add.sprite(350,260,'yellow-button');
    b.scale.setTo(1.5,1.5);
    group1.add(game.add.text(355, 265, 'B', { font:  '45px AlfaSlab', fill: "#013884", align: "center"}));

    c=this.game.add.sprite(450,260,'button');
    c.scale.setTo(1.5,1.5);
    group1.add(game.add.text(455, 265, 'C', { font:  '45px AlfaSlab', fill: "#013884", align: "center"}));

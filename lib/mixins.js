...
//type:: listaDeTuplasConNombreDeBotonYCallback -> [(nombreDeBoton, Callback)]
 ...
 notification(title, text, listaDeTuplasConNombreDeBotonYCallback){
  ...
  notificacionGroup.add(back);
      ...
      var splash = this.game.add.bitmapData(700,500);
      var  grd2 = splash.context.createLinearGradient(0,0,700,500);
  ...
  notificacionGroup.add(board);
      ...
      var line=self.createLineGlobal(20,70, 680, false, 0xffb204);
 ...
 /* Crea Botones Con el diseño de los splash para las notificaciones.
...
//type:: listaDeTupla -> [(nombreDeBoton, Callback)]
 ...
 generateButtonsInSplash: function(listaDeTupla){
       ...
       for(var i=0; i< listaDeTupla.length; i++ ){
              ...
              var nombreBoton= game.add.text( 10,10, listaDeTupla[i][0], { font:  '15px CondensedLight', fill: 'black', align: "center"});

              var colorBoton = this.game.add.bitmapData(nombreBoton.width+20,nombreBoton.height+20);
              var  grd = colorBoton.context.createLinearGradient(0,0,0,(nombreBoton.height+20)/2);
              grd.addColorStop(0,"#fbe43e");
              grd.addColorStop(0.9,"#fbe43e");
              grd.addColorStop(1,"#cea428");
              colorBoton.context.fillStyle = grd;
              colorBoton.context.fillRect(0,0,nombreBoton.width+20,nombreBoton.height+20);
              var boton=this.game.add.sprite(10+(positionX*200),positionY,colorBoton);
            ...
            //   var testMask=game.add.graphics(0, 0);
            //   testMask.beginFill(0xFFFF0B, 0.5);
            //   testMask.drawRoundedRect(0, 0,background.width ,40,10);
            //   testMask.endFill();
            //  //
            //   buttons.add(testMask);
            //   boton.mask=testMask;
 ...
 */
  createSoundGraphics: function(){
    ...
    if( fondoMusic.mute == true){
      musica= game.add.sprite(this.game.width-50,40, 'musica-off');
      musica.scale.setTo(1.20,1.2);
      activateSonido=false;
    }else{
      musica= game.add.sprite(this.game.width-50,40, 'musica-on');
      musica.scale.setTo(1.20,1.2);
      activateSonido=true;
    }

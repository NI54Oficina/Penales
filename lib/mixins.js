...
screen3M: function(){
  ...
  cartel=this.game.add.sprite(350,150,'cartel-2');
...
notificationWithButton: function( title, text, lista, tiempoDeEspera){
...
// [['BotonPrueba', self.testGlobal, "parametroQueRecibe"],['BotonPrueba2', self.testGlobal, "parametroQueRecibe"]]
  ...
  groupoTotal.add(self.notificationDinamic(title, text, false, 1));

  groupoTotal.onComplete(function(){

    for(var i=0; i< lista.length; i++){
     self.createButton(lista[i][0], lista[i][1]).position={x:,y:};

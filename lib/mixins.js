...
//type:: listaDeTupla -> [(nombreDeBoton, Callback)]
 ...
 generateButtonsInSplash: function(listaDeTupla){
       ...
       for(var i=0; i< listaDeTupla.length; i++ ){
              ...
              var colorBoton = this.game.add.bitmapData(210,nombreBoton.height+20);
              console.log(nombreBoton.width+30);
              var  grd = colorBoton.context.createLinearGradient(0,0,0,105);
              grd.addColorStop(0,"#fbe43e");
              grd.addColorStop(0.9,"#fbe43e");
              grd.addColorStop(1,"#cea428");
              colorBoton.context.fillStyle = grd;
              colorBoton.context.fillRect(0,0,210,nombreBoton.height+20);
              var boton=this.game.add.sprite(10+(positionX*250),positionY,colorBoton);
              ...
              testMask.drawRoundedRect(0, 0,210 ,nombreBoton.height+20,5);
              testMask.endFill();

...
screen3: function(){
    ...
    group1.add(game.add.text(0, 80, 'Soltá cuando el indicador esté en la zona verde de la barra', { font:  '25px TheSansRegular', fill: "#013884", align: "center",wordWrap: true, wordWrapWidth:600}));

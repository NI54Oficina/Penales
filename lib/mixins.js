...
screen2: function(){
    ...
    father= this.game.add.sprite(160,220,'arco-n');
    father.scale.setTo(.5,.5);

    d= this.game.add.sprite(20,220,'arco-0');
    d.scale.setTo(.5,.5);

    a=this.game.add.sprite(190,260,'orange-button');
    // a.scale.setTo(1.5,1.5);
    group1.add(game.add.text(195, 265, 'A', { font:  '20px AlfaSlab', fill: "#013884", align: "center"}));

    b=this.game.add.sprite(280,260,'yellow-button');
    // b.scale.setTo(1.5,1.5);
    group1.add(game.add.text(285, 265, 'B', { font:  '20px AlfaSlab', fill: "#013884", align: "center"}));

    c=this.game.add.sprite(380,260,'button');
    // c.scale.setTo(1.5,1.5);
    group1.add(game.add.text(385, 265, 'C', { font:  '20px AlfaSlab', fill: "#013884", align: "center"}));

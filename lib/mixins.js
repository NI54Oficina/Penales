...
//type:: listaDeTuplasConNombreDeBotonYCallback -> [(nombreDeBoton, Callback)]
 ...
 notification(title,boolIns, text, listaDeTuplasConNombreDeBotonYCallback){
  ...
  notificacionGroup.add(board);
      ...
      var x=game.add.text(50, 30, title, { font:  '30px RobotoBold', fill: "#013884", align: "center"});
      x.setShadow(2, 2, ' #ffc400', 0);
      var line=self.createLineGlobal(20,70, 880, false, 0xffb204);
...
screen1: function(){
    ...
    group1=game.add.group();
      group1.add(game.add.text(0, 0, '1', { font:  '45px RobotoBold', fill: "#013884", align: "center"}));
    group1.add(game.add.text(0, 80, 'Seleccioná el rival al que vas a enfrentar', { font:  '20px RobotoBold', fill: "#013884", align: "center",wordWrap: true, wordWrapWidth:500}));
...
screen2: function(){
    ...
    group1=game.add.group();
      group1.add(game.add.text(0, 0, '2', { font:  '45px RobotoBold', fill: "#013884", align: "center"}));
    group1.add(game.add.text(0, 80, 'Mantené pulsado sobre uno de los seis lugares del arco a donde vas a apuntar ', { font:  '20px RobotoBold', fill: "#013884", align: "center",wordWrap: true, wordWrapWidth:500}));

    father= this.game.add.sprite(0,100,'arco-n');
    father.scale.setTo(.65,.65);
    // a=this.game.add.sprite(father.width,110,'img-1');
    // a.scale.setTo(.3,.3);
    // b=this.game.add.sprite(father.width+father.width/2,110,'img-1');
...
screen3: function(){
    ...
    group1=game.add.group();
      group1.add(game.add.text(0, 0, '3', { font:  '45px RobotoBold', fill: "#013884", align: "center"}));
    group1.add(game.add.text(0, 80, 'Soltá cuando el indicador esté en la zona verde de la barra', { font:  '20px RobotoBold', fill: "#013884", align: "center",wordWrap: true, wordWrapWidth:500}));

    father= this.game.add.sprite(0,100,'pelota');
    father.scale.setTo(.65,.65);
    // a=this.game.add.sprite(father.width,110,'img-1');
    // a.scale.setTo(.3,.3);
    // b=this.game.add.sprite(father.width+father.width/2,110,'img-1');
...
//type:: listaDeTupla -> [(nombreDeBoton, Callback)]
 ...
 generateButtonsInSplash: function(listaDeTupla){
       ...
       for(var i=0; i< listaDeTupla.length; i++ ){
              ...
              console.log(nombreBoton.width+30);

...
// FUNCIONES PARA LOS SPLASH DE NOTIFICACION
 ...
 notification(title, text){
  ...
  notificacionGroup.add(board);
      ...
      var x=game.add.text(50, 30, title, { font:  '30px CondensedLight', fill: "gray", align: "center"});
  ...
  board.addChild(m);
      ...
      var exit=game.add.text(board.width+board.x-20, board.y-40, 'X', { font:  '30px CondensedLight', fill: 'red', align: "center"});
